...
## WebDriverExtensions.PersistentSendKeys(IWebDriver, By, string, bool) Method
...
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentSendKeys(IWebDriver_By_string_bool)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentSendKeys(IWebDriver_By_string_bool)-by'></a>
`by` [OpenQA.Selenium.By](https://docs.microsoft.com/en-us/dotnet/api/OpenQA.Selenium.By 'OpenQA.Selenium.By')  
The locating mechanism to use.  
  
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentSendKeys(IWebDriver_By_string_bool)-text'></a>
`text` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The keys to send.  
  
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentSendKeys(IWebDriver_By_string_bool)-clear'></a>
