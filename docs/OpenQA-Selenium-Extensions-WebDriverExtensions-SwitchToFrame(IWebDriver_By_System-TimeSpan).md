...
## WebDriverExtensions.SwitchToFrame(IWebDriver, By, System.TimeSpan) Method
If the frame is available it switches the given driver to the specified frame.  
```csharp
public static IWebDriver SwitchToFrame(this IWebDriver driver, By by, System.TimeSpan timeout);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SwitchToFrame(IWebDriver_By_System-TimeSpan)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SwitchToFrame(IWebDriver_By_System-TimeSpan)-by'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SwitchToFrame(IWebDriver_By_System-TimeSpan)-timeout'></a>
