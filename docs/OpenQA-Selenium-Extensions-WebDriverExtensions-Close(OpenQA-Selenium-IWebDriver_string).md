...
An [OpenQA.Selenium.IWebDriver](https://docs.microsoft.com/en-us/dotnet/api/OpenQA.Selenium.IWebDriver 'OpenQA.Selenium.IWebDriver') extension method that closes a window by the given window index.  
```csharp
public static OpenQA.Selenium.IWebDriver Close(this OpenQA.Selenium.IWebDriver driver, string windowName);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-Close(OpenQA-Selenium-IWebDriver_string)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-Close(OpenQA-Selenium-IWebDriver_string)-windowName'></a>
`windowName` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
