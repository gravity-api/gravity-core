...
## WebDriverExtensions.SwitchToFrame(IWebDriver, By) Method
If the frame is available it switches the given driver to the specified frame.  
```csharp
public static IWebDriver SwitchToFrame(this IWebDriver driver, By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SwitchToFrame(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SwitchToFrame(IWebDriver_By)-by'></a>
