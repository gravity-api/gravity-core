...
## WebDriverExtensions.GetElements(IWebDriver, By) Method
...
```csharp
public static System.Collections.Generic.IEnumerable<IWebElement> GetElements(this IWebDriver driver, By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetElements(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetElements(IWebDriver_By)-by'></a>
