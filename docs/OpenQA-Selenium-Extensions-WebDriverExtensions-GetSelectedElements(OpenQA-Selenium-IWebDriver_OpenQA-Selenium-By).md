...
## WebDriverExtensions.GetSelectedElements(OpenQA.Selenium.IWebDriver, OpenQA.Selenium.By) Method
...
```csharp
public static System.Collections.Generic.IEnumerable<OpenQA.Selenium.IWebElement> GetSelectedElements(this OpenQA.Selenium.IWebDriver driver, OpenQA.Selenium.By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetSelectedElements(OpenQA-Selenium-IWebDriver_OpenQA-Selenium-By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetSelectedElements(OpenQA-Selenium-IWebDriver_OpenQA-Selenium-By)-by'></a>
