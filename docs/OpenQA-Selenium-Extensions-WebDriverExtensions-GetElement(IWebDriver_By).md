...
## WebDriverExtensions.GetElement(IWebDriver, By) Method
...
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetElement(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetElement(IWebDriver_By)-by'></a>
