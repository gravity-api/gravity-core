...
## WebDriverExtensions.GetSelectedElements(IWebDriver, By) Method
...
```csharp
public static System.Collections.Generic.IEnumerable<IWebElement> GetSelectedElements(this IWebDriver driver, By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetSelectedElements(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetSelectedElements(IWebDriver_By)-by'></a>
