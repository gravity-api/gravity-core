...
## WebDriverExtensions.SendPostCommand(IWebDriver, string, System.Collections.Generic.IDictionary&lt;string,object&gt;) Method
...
```csharp
public static string SendPostCommand(this IWebDriver driver, string route, System.Collections.Generic.IDictionary<string,object> data);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SendPostCommand(IWebDriver_string_System-Collections-Generic-IDictionary-string_object-)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SendPostCommand(IWebDriver_string_System-Collections-Generic-IDictionary-string_object-)-route'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-SendPostCommand(IWebDriver_string_System-Collections-Generic-IDictionary-string_object-)-data'></a>
