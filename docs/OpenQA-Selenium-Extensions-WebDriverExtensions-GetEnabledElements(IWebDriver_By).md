...
## WebDriverExtensions.GetEnabledElements(IWebDriver, By) Method
...
```csharp
public static System.Collections.Generic.IEnumerable<IWebElement> GetEnabledElements(this IWebDriver driver, By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetEnabledElements(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetEnabledElements(IWebDriver_By)-by'></a>
