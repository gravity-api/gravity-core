...
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-Close(OpenQA-Selenium-IWebDriver_int)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-Close(OpenQA-Selenium-IWebDriver_int)-index'></a>
