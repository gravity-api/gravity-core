...
## WebDriverExtensions.PersistentClick(IWebDriver, By, System.TimeSpan) Method
Persistently attempts to find and click on the given element, until successful  
or until no exceptions has been thrown.  
```csharp
public static IWebDriver PersistentClick(this IWebDriver driver, By by, System.TimeSpan timeout);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentClick(IWebDriver_By_System-TimeSpan)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentClick(IWebDriver_By_System-TimeSpan)-by'></a>
`by` [OpenQA.Selenium.By](https://docs.microsoft.com/en-us/dotnet/api/OpenQA.Selenium.By 'OpenQA.Selenium.By')  
The locating mechanism to use.  
  
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-PersistentClick(IWebDriver_By_System-TimeSpan)-timeout'></a>
