...
## ExpectedConditions.SelectedOfAllElementsLocatedBy(By) Method
...
```csharp
public static System.Func<IWebDriver,System.Collections.ObjectModel.ReadOnlyCollection<IWebElement>> SelectedOfAllElementsLocatedBy(By by);
```
#### Parameters
<a name='OpenQA-Selenium-Common-ExpectedConditions-SelectedOfAllElementsLocatedBy(By)-by'></a>
