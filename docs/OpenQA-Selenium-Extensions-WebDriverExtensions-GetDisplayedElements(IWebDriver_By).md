...
## WebDriverExtensions.GetDisplayedElements(IWebDriver, By) Method
...
```csharp
public static System.Collections.Generic.IEnumerable<IWebElement> GetDisplayedElements(this IWebDriver driver, By by);
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetDisplayedElements(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetDisplayedElements(IWebDriver_By)-by'></a>
