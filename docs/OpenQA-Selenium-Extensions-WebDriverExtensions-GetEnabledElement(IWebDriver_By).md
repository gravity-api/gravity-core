...
## WebDriverExtensions.GetEnabledElement(IWebDriver, By) Method
...
```
#### Parameters
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetEnabledElement(IWebDriver_By)-driver'></a>
...
<a name='OpenQA-Selenium-Extensions-WebDriverExtensions-GetEnabledElement(IWebDriver_By)-by'></a>
